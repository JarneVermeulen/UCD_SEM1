...
### Materiaal
Het eerste deel van de opdracht, de hiërarchische taakanalyse, wordt uitgevoerd in een Miro template. Als extra hulp is er storytelling uitgevoerd met schetsen (zie Miro), om zo een beter beeld te hebben van de user journey.  Aan de hand van deze 2 methodes werden in  Protopie templates (bijlage 7.3) aagemaakt met het uiterlijk dat bekomen werd uit deelopdracht 4. De templates bevat de verschillende interacties die noodzakelijk zijn voor een spelverloop. Aangezien er soms meerdere interactie mogelijkheden zijn voor een bepaalde functie, werden er 2 versies gemaakt. Ook telkens een versie voor de jager en 1 voor de vluchter.
<table border="1">
    <tr>
...
<table border="1">
    ...
    <tr>
        <td><img src="finaal prototype/render met logo.jpg" width="100%"/></td>
    </tr>
</table>
